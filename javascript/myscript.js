...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Tim anh đập như vậy là vì:';
document.querySelector('.Description .modal-body').innerHTML = 'Anh yêuuu em nhiều lắm đó trừi ưi <i class="fas fa-heart"></i> ';
